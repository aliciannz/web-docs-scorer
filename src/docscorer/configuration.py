...
class ScorerConfiguration:
    def __init__(self, args: dict = None):
        ...
        self.text_in_output = args.get("--text_in_output") if args is not None else False
        self.only_final_score = args.get("--only_final_score") if args is not None else False
...
class InformativenessConfiguration:
