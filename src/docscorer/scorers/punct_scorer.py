...
class PunctScorer:
    ...
    def score(
        ...
        if percent_desired_min <= ratio <= percent_desired_max:
            ...
            return scale_value(ratio, percent_max, percent_bad[0], self.MIN_SCORE, 5.0)
        elif ratio >= percent_semibad[0]:
            return scale_value(ratio, percent_bad[0], percent_semibad[0], 5.0, 7.0)
            ...
            return scale_value(ratio, 0.0, percent_semibad[1], self.MIN_SCORE, 5.0)
